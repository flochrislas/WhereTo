...
$resto = Restaurant::create(array(
        ...
        $resto = Restaurant::create(array(
            ...
            'experience'        => 'The burger was really delicious, one the of the best in the area.',
            'visited'           => true,
        ...
        $resto->attachTags(['cafe','italian','smoking allowed','English menu']);
